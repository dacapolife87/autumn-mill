...
<%
String urlurl = "ftp://192.168.0.2";
String fileName ="";
	try{
		String savePath = "C:/Users/dacapolife/workspace/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/dbtest/at1/img";
    	...
    	if(fileName == null) { // 파일이 업로드 되지 않았을때
			...
			response.sendRedirect("jsonTestTest.jsp");
